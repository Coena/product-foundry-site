/**
 * hex.grid.businesscanvas.js
 *
 * Based on hex.grid.hexagonal.js with some changes.
 *
 * - Rotation, so that the hexagons point up.
 */
(function(hex, undefined){
    ...
    /**
     * The business canvas grid prototype.
     */
    hex.grid.businesscanvas = {
